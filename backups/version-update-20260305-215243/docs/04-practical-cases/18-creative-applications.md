# 第18章 创意应用探索（AI绘画/视频/翻译/数据分析）

> 提示： **本章目标**：探索OpenClaw在创意领域的应用，包括AI绘画工作流、视频脚本生成、多语言翻译和数据分析自动化。
...
1. **安装bananapro-image-gen Skill**: 
   - 详细步骤请参考 --> [第14章 14.1.2节 安装bananapro-image-gen Skill](../03-advanced/14-api-integration.md#1412-安装bananapro-image-gen-skill)
   - 包含GitHub安装和npx命令两种方式

2. **配置API密钥**: 
   - 详细步骤请参考 --> [第14章 14.1.3节 配置API](../03-advanced/14-api-integration.md#1413-配置api)
   - 包含API密钥获取和配置方法

3. **基础使用教程**: 
   - 详细步骤请参考 --> [第14章 14.1.4节 基础使用教程](../03-advanced/14-api-integration.md#1414-基础使用教程)
   - 了解基本的绘图命令和参数
...
# 测试绘图功能
openclaw message send "帮我画一个可爱的小猫"
```

如果看到OpenClaw开始生成图片,说明配置成功,可以继续下面的实战案例了。

提示： **提示**: 第14章提供了完整的技术文档和配置说明,本章专注于实战应用案例。建议先完成第14章的学习再回到本章。

### 18.1.3 手机上用OpenClaw画图
...
【数据】 【销售周报】2026-02-03 至 2026-02-09
...
**下一章预告**：第19章将学习一人公司实战案例，包括安装配置、API连接、Skills加载和性能优化等问题的完整解决方案。
