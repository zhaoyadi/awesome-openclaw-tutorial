# 第15章 高级配置（多模型切换/成本优化/性能调优）

> 提示： **本章目标**：掌握OpenClaw的高级配置技巧，包括多模型切换、成本优化和性能调优。
...
> 【智能】 **智能记忆**：配置 Memory Search 让 OpenClaw 记住历史对话，提供更智能的上下文感知。

### 15.3.1 什么是 Memory Search？
...
> 【AI】 **多模型支持**：OpenClaw 支持 20+ 主流 AI 模型提供商，灵活配置满足不同需求。

### 15.6.0 快速配置：使用命令行向导（推荐新手）

> 提示： **最简单的方式**：使用 `openclaw onboard` 命令启动配置向导，交互式配置模型。
...
> 【配置】 **扩展能力**：OpenClaw 的工具系统让 AI 能够执行各种操作，从文件管理到 API 调用。
...
**下一章预告**：第16章将进入实战案例部分，学习个人效率提升的完整工作流。
