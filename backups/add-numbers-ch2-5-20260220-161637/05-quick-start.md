...
![image-20260217093646355](https://upload.maynor1024.live/file/1771292219417_image-20260217093646355.png)
...
![nanobananapro-f4cf9d4d-92b3-4ce5-a2ce-b38e5873b2d4-0](https://upload.maynor1024.live/file/1771301953776_nanobananapro-f4cf9d4d-92b3-4ce5-a2ce-b38e5873b2d4-0.png)
...
> 💡 **快速选择**：新手推荐 Claude Haiku 4.5 或 DeepSeek，性价比高且完全够用。详细的模型对比和切换策略请参考 [第15章：高级配置](../03-advanced/15-advanced-configuration.md)。
...
```
> 📚 **想了解更多？**
> 详细的模型对比、多模型切换策略、成本优化方案，请参考 [第15章：高级配置](../03-advanced/15-advanced-configuration.md)。
...
**下一章**：[第6章：本地文件管理](../02-core-features/06-file-management.md) - 让OpenClaw成为你的文件管理神器
